     ...
     if ($("#clock").length) {
        ...
        $('#clock').countdown(time.replace(/-/g,'/'), function(event) {
            if(event.type == 'stoped'){
                $(this).html(''
                    + '<div class="box"><div>00</div> <span>'+ $('#clock').data('text-day') +'</span> </div>'
                    + '<div class="box"><div>00</div> <span>'+ $('#clock').data('text-hour') +'</span> </div>'
                    + '<div class="box"><div>00</div> <span>'+ $('#clock').data('text-minute') +'</span> </div>'
                    + '<div class="box"><div>00</div> <span>'+ $('#clock').data('text-second') +'</span> </div>');
            }else{
